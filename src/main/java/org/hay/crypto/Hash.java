...
import org.hay.crypto.jce.hayCastleProvider;
import org.hay.trie.TrieImpl;
...
import static org.hay.utils.ByteUtil.EMPTY_BYTE_ARRAY;
...
public class Hash {
    ...
    static {
        Security.addProvider(hayCastleProvider.getInstance());
        CRYPTO_PROVIDER = Security.getProvider("SC");
        HASH_256_ALGORITHM_NAME = "hay-KECCAK-256";
        HASH_512_ALGORITHM_NAME = "hay-KECCAK-512";
        try {
