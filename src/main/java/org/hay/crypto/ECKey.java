package org.hay.crypto;

import org.hay.crypto.jce.*;
import org.hay.utils.ByteUtil;
...
import static org.hay.utils.BIUtil.isLessThan;
import static org.hay.utils.ByteUtil.bigIntegerToBytes;
...
public class ECKey implements Serializable {
    ...
    public ECKey(SecureRandom secureRandom) {
        this(hayCastleProvider.getInstance(), secureRandom);
    }
    ...
    private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
        if (priv == null) {
            ...
            try {
                return ECKeyFactory
                        .getInstance(hayCastleProvider.getInstance())
